...
import { StatusBadge, PriorityBadge, Button, Badge } from "@/components/ui";
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                {adultMembers.map((member, index) => (
                  <div key={member.id} className="px-3 py-2 bg-surface-50 rounded-lg">
                    <span className="text-xs text-surface-500 mr-2">{index + 1}.</span>
                    <span className="text-sm text-surface-900">{member.full_name}</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-2">
                  {childMembers.map((member, index) => (
                    <div key={member.id} className="px-3 py-2 bg-amber-50 rounded-lg">
          ...
          <div className="card p-6">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-surface-900 font-medium">{totalPax}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-surface-500">Adults</span>
                <span className="text-surface-900">{inquiry.no_of_adults}</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-surface-500">Children</span>
                <span className="text-surface-900">{inquiry.no_of_children || 0}</span>
              </div>
              <div className="flex justify-between text-sm">
