...
export function GenerateVouchersButton({
  ...
  if (existingVouchersCount > 0) return null;
  ...
  return (
    <>
      <Button
        ...
        disabled={isDisabled}
        title={isDisabled ? "Finalize tour first before generating vouchers" : ""}
      >
        ...
        {existingVouchersCount > 0 && (
          <span className="ml-2 px-1.5 py-0.5 bg-primary-100 text-primary-700 rounded-full text-[10px] font-bold">
            {existingVouchersCount}
          </span>
        )}
      </Button>
