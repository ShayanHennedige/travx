            ...
            <div className="bg-surface-900 px-4 md:px-6 py-5 border-b border-surface-800 text-white transition-colors duration-300">
              <div className="flex flex-col md:flex-row items-start justify-between gap-6">
                <div className="flex items-start gap-4 flex-1">
                  <div className="flex-shrink-0 w-10 md:w-12 h-10 md:h-12 rounded-xl bg-surface-800 border border-surface-700 text-teal-400 flex items-center justify-center font-bold text-base md:text-lg shadow-sm group-hover:bg-teal-400 group-hover:text-surface-900 transition-colors duration-300">
                    {day.day}
                  </div>
