...
export function Sidebar() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 bg-surface-900 text-white">
      <div className="flex h-full flex-col">
        ...
        <div className="flex h-16 items-center gap-3 px-6 border-b border-surface-700">
          ...
          <div>
            <h1 className="text-lg font-semibold tracking-tight">TravX</h1>
            <p className="text-xs text-surface-400">Inquiry Management</p>
          </div>
        </div>
        ...
        <div className="px-3 pb-3">
          <button
            ...
            className="flex w-full items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-surface-300 hover:bg-surface-800 hover:text-white transition-colors border border-dashed border-surface-600"
          >
        ...
        <div className="p-3 border-t border-surface-700">
          <button
            ...
            className="flex w-full items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-surface-300 hover:bg-surface-800 hover:text-white transition-colors"
          >
